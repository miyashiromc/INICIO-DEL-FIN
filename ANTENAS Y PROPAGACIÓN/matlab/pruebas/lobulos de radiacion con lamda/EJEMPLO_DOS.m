% Dipole L = lambda - Patrón 3D y cortes H-plane y E-plane
clc; clear; close all;
...
c      = 3e8;
lambda = c/f;
L      = lambda;      % dipolo de longitud lambda
k      = 2*pi/lambda;
...
title('H-plane (phi=pi/2) - L=lambda');
...
title('E-plane (theta=0) - L=lambda');
